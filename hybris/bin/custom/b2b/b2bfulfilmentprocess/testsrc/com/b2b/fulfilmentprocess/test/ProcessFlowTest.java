 ...
 */
package com.b2b.fulfilmentprocess.test;
...
import com.b2b.fulfilmentprocess.test.actions.TestActionTemp;
...
public class ProcessFlowTest extends HybrisJUnit4Test
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/b2bfulfilmentprocess/test/b2bfulfilmentprocess-spring-test.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/b2bfulfilmentprocess/test/process/order-process-spring.xml"));
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/b2bfulfilmentprocess/test/process/consignment-process-spring.xml"));
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/b2bfulfilmentprocess/test/b2bfulfilmentprocess-spring-testcleanup.xml"));
